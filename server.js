 ...
 */
var APP_ID = 'A383C262-2610-40EA-9083-FBA33A055FC5';
var USER_ID = 'test1';
var TOKEN = 'b7328be72ccfa7704d81636160d27d9ddcdac43c';
var ENTRYPOINT =
	'https://api-A383C262-2610-40EA-9083-FBA33A055FC5.sendbird.com';
 ...
 */
var DIALOGFLOW_PROJECT_ID = 'agent-nwom';
...
app.post('/callback', express.json(), async (req, res) => {
	...
	if (message && bot && channel) {
		...
		sendToDialogFlow(msgText, async (response) => {
			 ...
			 */
			await fromDialogFlowSendMessageToChannel(
				response,
				channelUrl,
				botId
			);
...
app.listen(5500, () =>
	console.log('Sendbid DialogFlow BOT listening on port 5500!')
);
...
async function fromDialogFlowSendMessageToChannel(
	queryText,
	channelUrl,
	botId
) {
